...
public class IRPathingData extends PathingData {
    ...
    public static IRPathingData wrap(PathingData inputData) {
    ...
    @Deprecated
    @Override
    public PathingData setPos(net.minecraft.world.phys.Vec3 pos) {
        super.setPos(pos);
